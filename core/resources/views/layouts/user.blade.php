    ...
    <div class="sidebar-menu">
        ...
        <div class="sidebar-menu-inner">
            ...
            <ul id="main-menu" class="main-menu">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('manual-fund-add') }}">
                                ...
                                <span class="title">Add via Bank</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('manual-fund-history') }}">
                                <span class="title"><i class="fa fa-history"></i> Bank Funding History</span>
                            </a>
                        </li>
                ...
                <li class="has-sub">
                    <a href="#">
                        <span class="title"><i class="fa fa-line-chart"></i> Manage Investment</span>
                    </a>
                    <ul>
                        <li>
                            <a href="{{ route('deposit-new') }}">
                                <i class="fa fa-plus"></i>
                                <span class="title">New Invest</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('deposit-history') }}">
                                <span class="title"><i class="fa fa-history"></i> Invest History</span>
                            </a>
                        </li>

                    </ul>
                </li>
                <li class="{{ Request::is('repeat-history') ? " opened active" : "" }}">
                ...
                <li class="has-sub">
                    <a href="#">
                        <span class="title"><i class="fa fa-server"></i> Reference Bonus</span>
                    </a>
                    <ul>
                        <li>
                            <a href="{{ route('reference-user') }}">
                                <i class="fa fa-users"></i>
                                <span class="title">Reference User</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('reference-history') }}">
                                <span class="title"><i class="fa fa-history"></i> Bonus History</span>
                            </a>
                        </li>
                ...
                <ul class="user-info pull-right pull-none-xsm">
                    ...
                    <li class="profile-info dropdown"><!-- add class "pull-right" if you want to place this from right -->
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            {{ Auth::user()->name }} - ({{ $basic->symbol }} {{ Auth::user()->amount }}) <i class="fa fa-sort-down"></i>
                        </a>
