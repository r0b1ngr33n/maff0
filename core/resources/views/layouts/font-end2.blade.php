                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 contact_us">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <img style="width:100%;" class="image-responsive" src="{{ asset('assets/images') }}/{{ $payment->paypal_image }}" alt="">
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <img style="width:100%;" class="image-responsive" src="{{ asset('assets/images') }}/{{ $payment->perfect_image }}" alt="">
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <img style="width:100%;" class="image-responsive" src="{{ asset('assets/images') }}/{{ $payment->btc_image }}" alt="">
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <img style="width:100%;" class="image-responsive" src="{{ asset('assets/images') }}/{{ $payment->stripe_image }}" alt="">
                            </div>
                        </div>
                    </div>
