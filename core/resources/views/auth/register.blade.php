                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-lg-offset-3 col-md-offset-3 col-xs-12">
                    ...
                    <form method="post" accept-charset="utf-8" class="block" enctype="multipart/form-data" action="{{ route('register') }}">
                        ...
                        <div class="input-group">
                            <input type="text" name="reference" value="{{ $basic->reference_id }}" required class="form-control" placeholder="Enter Reference ID *" aria-describedby="basic-addon1">
                            <span class="input-group-addon" id="basic-addon1"><i class="fa fa-handshake-o"></i></span>
                        </div>

                        <div class="input-group">
                            <input type="text" name="name" value="" required class="form-control" placeholder="Name *" aria-describedby="basic-addon1">
                    ...
                    @endif
                        <div class="login_option clear_fix">
                            <div style="width: 100%;" class="submit_button flt_left">
                                <button style="width: 100%" type="submit" class="transition3s hvr-sweep-to-rightB"><i class="fa fa-send"></i> Registration</button>
                            </div> <!-- /submit_button -->
                        </div> <!-- /login_option -->
                    </form>
                </div>
