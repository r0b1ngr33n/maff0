...
@section('content')
    ...
    <div class="panel panel-success" data-collapsed="0">
        ...
        <!-- panel head -->
        <div class="panel-heading">
            <div class="panel-title"><strong><i class="fa fa-cloud-download"></i> Invest Plan Statistics</strong></div>
        ...
        <div class="panel-body">
            ...
            <div class="col-sm-4 col-xs-6">
                <div class="tile-stats tile-green">
                    <div style="bottom: 40px;" class="icon"><i class="fa fa-bars"></i></div>
                    <div class="num" data-start="0" data-end="{{ $total_plan }}" data-postfix=" - Plan" data-duration="1500" data-delay="0">0</div>
            ...
            <div class="col-sm-4 col-xs-6">
                <div class="tile-stats tile-blue">
                    <div style="bottom: 40px;" class="icon"><i class="fa fa-check-square-o"></i></div>
                    <div class="num" data-start="0" data-end="{{ $active_plan }}" data-postfix=" - Plan" data-duration="1500" data-delay="0">0</div>
                    <h3>Active Plan</h3>
                </div>
            </div>
            <div class="col-sm-4 col-xs-6">
                <div class="tile-stats tile-red">
                    <div style="bottom: 40px;" class="icon"><i class="fa fa-times"></i></div>
                    <div class="num" data-start="0" data-end="{{ $deactive_plan }}" data-postfix=" - Plan" data-duration="1500" data-delay="0">0</div>
                    <h3>Deactive Plan</h3>
                </div>
            </div>
    ...
    <div class="panel panel-info" data-collapsed="0">
        ...
        <!-- panel head -->
        <div class="panel-heading">
            <div class="panel-title"><strong><i class="fa fa-random"></i> Transaction Method</strong></div>
        ...
        <div class="panel-body">
            ...
            <div class="col-sm-3 col-xs-6">
                <div class="tile-stats tile-blue">
                    <div style="bottom: 40px;" class="icon"><i class="fa fa-check-square-o"></i></div>
                    <div class="num" data-start="0" data-end="{{ $active_fund }}" data-postfix="" data-duration="1500" data-delay="0">0</div>
                    <h3>Active Method</h3>
                </div>
            </div>
            <div class="col-sm-3 col-xs-6">
            ...
            <div class="col-sm-3 col-xs-6">
                <div class="tile-stats tile-green">
                    ...
                    <div class="num" data-start="0" data-end="{{ $active_withdraw }}" data-postfix="" data-duration="1500" data-delay="0">0</div>
                    <h3>Active Withdraw</h3>
                </div>
            </div>
